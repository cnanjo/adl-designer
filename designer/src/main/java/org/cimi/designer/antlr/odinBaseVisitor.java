...
public class odinBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements odinVisitor<T> {
    ...
    private static Logger log = LogManager.getLogger(odinBaseVisitor.class.getName());
...
//        }
     ...
     *
     * <code><pre>keyed_object : '[' primitive_value ']' '=' object_block ;</pre></code>
     */
    @Override
